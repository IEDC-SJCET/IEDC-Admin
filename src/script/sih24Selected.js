...
const firestoreName = "sih-hackathon-selected-24";
 ...
 */
export const sihSelectedForm = async () => {
...
function bodyTemplate(data, docId) {
  let template = `<tr>
                    ...
                    <td>${
                      data.teamLeader.gender ? data.teamLeader.gender : ""
                    }</td>
                    <td>${data.teamLeader.stay}</td>
                    <td>${
                    ...
                    <td>${data.members[0]?.member2Gender || ""}</td>
                    <td>${data.members[0]?.member2Stay || ""}</td>
                    ...
                    <td>${data.members[1]?.member3Gender || ""}</td>
                    <td>${data.members[1]?.member3Stay || ""}</td>
                    ...
                    <td>${data.members[2]?.member4Gender || ""}</td>
                    <td>${data.members[2]?.member4Stay || ""}</td>
                    ...
                    <td>${data.members[3]?.member5Gender || ""}</td>
                    <td>${data.members[3]?.member5Stay || ""}</td>
                    ...
                    <td>${data.members[4]?.member6Gender || ""}</td>
                    <td>${data.members[4]?.member6Stay || ""}</td>
