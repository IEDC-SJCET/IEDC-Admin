...
import { getFirestore, getDocs, addDoc, collection } from "https://www.gstatic.com/firebasejs/9.12.1/firebase-firestore.js";
...
const picStorage = getStorage(app);
const storageRef = ref(picStorage, 'some-child');
